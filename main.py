...
def main():
    ...
    GNN = GCN(input_features=2, hidden_channels=12,
              output_classes=12, layers=4)
    print(GCN)
    readout = GlobalMLP(input_features=12*data.M, hidden_channels=12*data.M,
...
def grad_steps(x, z, zc, args, utils, idx, plotFlag):
    ...
    for i in range(num_steps):
        delz, delphiz = utils.corr_steps(z_new, zc_new, idx)
